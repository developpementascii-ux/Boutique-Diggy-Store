    ...
    if (Array.isArray(itemsToImport) && itemsToImport.length > 0) {
      const newEntries = itemsToImport.map((item) => {
        ...
        return {
          ...
          notes: item.notes || `Généré depuis alerte stock. Stock actuel : ${currentStock} (Seuil : ${threshold})`,
          clientName: '',
          clientPhone: '',
          clientDeposit: 0,
    ...
    lowStockItems.forEach((prod) => {
      ...
      if (!alreadyListed) {
        ...
        const newPo = {
          ...
          notes: `Généré automatiquement depuis alerte stock. Stock actuel : ${currentStock} (Seuil : ${threshold})`,
          clientName: '',
          clientPhone: '',
          clientDeposit: 0,
